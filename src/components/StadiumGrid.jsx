...
export default function StadiumGrid({ zones }) {
        ...
        <div className="glass rounded-xl p-4 h-full">
            ...
            <div className="grid grid-cols-6 gap-1.5 md:gap-2">
              ...
              `}
                        ...
                        >
                            ...
                            {isCritical && (
                                <div className="absolute inset-0 rounded-lg border-2 border-fuchsia-500/60 animate-ping opacity-20" />
                            )}
            ...
            <div className="flex items-center justify-center gap-5 mt-4">
                <div className="flex items-center gap-1.5">
                    <span className="w-2.5 h-2.5 rounded-sm bg-cyan-400/40 border border-cyan-400/60" />
                    <span className="text-[9px] text-slate-500 font-mono">CLEAR 0-40%</span>
                </div>
                <div className="flex items-center gap-1.5">
                    <span className="w-2.5 h-2.5 rounded-sm bg-yellow-400/40 border border-yellow-400/60" />
                    <span className="text-[9px] text-slate-500 font-mono">BUSY 41-75%</span>
                </div>
                <div className="flex items-center gap-1.5">
                    <span className="w-2.5 h-2.5 rounded-sm bg-fuchsia-500/40 border border-fuchsia-500/60 zone-critical" />
